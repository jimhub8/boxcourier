                    ...
                    <v-card-title>
                        ...
                        <v-tooltip right>
                            <template v-slot:activator="{ on }">
                                ...
                                <v-btn v-on="on" icon slot="activator" class="mx-0" @click="getShipments">
                            ...
                            <td class="justify-center layout px-0" v-if="user.can['update charges']">
                                ...
                                <v-tooltip bottom>
                                    <template v-slot:activator="{ on }">
                                        ...
                                        <v-btn v-on="on" flat slot="activator" color="primary" icon class="mx-0" @click="openInvoice(props.item)">
